...
const PRODUTOS_INICIAIS = [
    ...
    // SUCOS
    { id: 132, nome: "Copo polpa (350ml)", preco: 12.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 133, nome: "Copo de Laranja, Limão ou Abacaxi", preco: 16.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 134, nome: "Copo Bacuri ou Cupuaçu (350ml)", preco: 18.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 135, nome: "Suco polpa composto (copo 350ml)", preco: 20.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 136, nome: "Suco polpa (jarra pequena 500ml)", preco: 26.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 137, nome: "Suco polpa (jarra grande 1300ml)", preco: 30.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 138, nome: "Suco Bacuri ou Cupuaçu (jarra grande)", preco: 32.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 139, nome: "Suco polpa composto (jarra pequena)", preco: 28.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 140, nome: "Suco polpa composto (jarra grande)", preco: 32.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 141, nome: "Suco de uva integral (garrafa)", preco: 18.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    { id: 142, nome: "Adicional de leite", preco: 4.00, categoria: "Sucos", icon: "🧃", type: "cambuza" },
    // ÁGUA DE COCO
    { id: 143, nome: "Água de Coco (copo 350ml)", preco: 14.00, categoria: "Bebidas Diversas", icon: "🥥", type: "cambuza" },
    { id: 144, nome: "Água de Coco (jarra pequena 500ml)", preco: 20.00, categoria: "Bebidas Diversas", icon: "🥥", type: "cambuza" },
    { id: 145, nome: "Água de Coco (jarra grande 1300ml)", preco: 26.00, categoria: "Bebidas Diversas", icon: "🥥", type: "cambuza" },
    // CAFÉS & CHÁS
